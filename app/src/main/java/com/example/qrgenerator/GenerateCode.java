    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        genback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(GenerateCode.this, MainActivity.class);
        ...
        qrgenbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(qrgentext.getText().toString().trim().length()==0) {
                    Toast.makeText(GenerateCode.this, "Text entering is required", Toast.LENGTH_SHORT).show();
                }
                else {
                    try{
                        ...
                        qrgendownload.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                Toast.makeText(GenerateCode.this, "Successfully Downloaded", Toast.LENGTH_SHORT).show();
                            }
                        });
